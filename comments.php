...
<div id="comments" class="comments-area">
    ...
    <?php if ( have_comments() ) : ?>
        <p class="comments-title uppercase">
            <?php
            printf( // WPCS: XSS OK.
                esc_html( _nx( 'Môt comment cho bài viết &ldquo;%2$s&rdquo;', '%1$s comment cho bài viết &ldquo;%2$s&rdquo;',
                    get_comments_number
                    (), 'comments title', 'flatsome' ) ),
        ...
        <?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // Are there comments to navigate through? ?>
            <nav id="comment-nav-below" class="navigation comment-navigation" role="navigation">
                <p class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'flatsome' ); ?></p>
